...
#[no_mangle]
unsafe extern fn dart_rust_async_ffi_Init(parent_library: ffi::Dart_Handle) -> ffi::Dart_Handle {
...
unsafe extern fn wrapped_random_array(_dest_port_id: ffi::Dart_Port,
                                      message: *mut ffi::Dart_CObject) {

    let reply_port_id;
    if (*message).type_ == ffi::Dart_CObject_Type::Array &&
...
unsafe extern fn randomArrayServicePort(arguments: ffi::Dart_NativeArguments) {
    ...
    if service_port != ffi::ILLEGAL_PORT { // https://github.com/dart-lang/sdk/blob/9a683de40dd5d0ab623b2a105295ea58964d6afc/runtime/include/dart_api.h#L1173
