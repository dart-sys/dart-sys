...
fn bindgen_test_layout_Dart_EmbedderInformation() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_EmbedderInformation>())).version as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_EmbedderInformation>())).current_rss as *const _ as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_EmbedderInformation),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_EmbedderInformation>())).max_rss as *const _ as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_EmbedderInformation),
...
fn bindgen_test_layout_Dart_CObject() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_CObject), "::", stringify!(type_))
	);
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_CObject>())).value as *const _ as usize },
		8usize,
		concat!("Offset of field: ", stringify!(Dart_CObject), "::", stringify!(value))
	);
}
...
fn bindgen_test_layout_Dart_CObjectValue() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_CObjectValue>())).as_external_typed_data as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_CObjectValue),
...
fn bindgen_test_layout_Dart_TypedData() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_TypedData), "::", stringify!(type_))
	);
	assert_eq!(
...
fn bindgen_test_layout_Dart_Array() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_Array), "::", stringify!(length))
	);
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_Array>())).values as *const _ as usize },
		8usize,
		concat!("Offset of field: ", stringify!(Dart_Array), "::", stringify!(values))
	);
}
...
fn bindgen_test_layout_Dart_Capability() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_Capability), "::", stringify!(id))
	);
}
...
fn bindgen_test_layout_Dart_SendPort() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_SendPort), "::", stringify!(id))
	);
	assert_eq!(
...
fn bindgen_test_layout_Dart_SourceFile() {
	...
	assert_eq!(
		...
		0usize,
		concat!("Offset of field: ", stringify!(Dart_SourceFile), "::", stringify!(uri))
	);
	assert_eq!(
...
fn bindgen_test_layout_Dart_KernelCompilationResult() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_KernelCompilationResult>())).status as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_KernelCompilationResult>())).error as *const _ as usize },
		8usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_KernelCompilationResult),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_KernelCompilationResult>())).kernel as *const _ as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_KernelCompilationResult),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_KernelCompilationResult>())).kernel_size as *const _ as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_KernelCompilationResult),
...
fn bindgen_test_layout_Dart_NativeArgument_Value() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_bool as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_int32 as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_uint32 as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_int64 as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_uint64 as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_double as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_string as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_native_fields as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_NativeArgument_Value>())).as_instance as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_NativeArgument_Value),
...
fn bindgen_test_layout__Dart_NativeArgument_Descriptor() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<_Dart_NativeArgument_Descriptor>())).type_ as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<_Dart_NativeArgument_Descriptor>())).index as *const _ as usize },
		1usize,
		concat!(
			"Offset of field: ",
			stringify!(_Dart_NativeArgument_Descriptor),
...
fn bindgen_test_layout_Dart_InitializeParams() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).vm_snapshot_data as *const _ as usize },
		8usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).vm_snapshot_instructions as *const _ as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).create_group as *const _ as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).initialize_isolate as *const _ as usize },
		32usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).shutdown_isolate as *const _ as usize },
		40usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).cleanup_isolate as *const _ as usize },
		48usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).cleanup_group as *const _ as usize },
		56usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).thread_exit as *const _ as usize },
		64usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).file_write as *const _ as usize },
		88usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).file_close as *const _ as usize },
		96usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).entropy_source as *const _ as usize },
		104usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).get_service_assets as *const _ as usize },
		112usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).start_kernel_isolate as *const _ as usize },
		120usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_InitializeParams>())).code_observer as *const _ as usize },
		128usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
...
fn bindgen_test_layout_Dart_IsolateFlags() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_IsolateFlags>())).enable_asserts as *const _ as usize },
		4usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_IsolateFlags>())).use_field_guards as *const _ as usize },
		5usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_IsolateFlags>())).load_vmservice_library as *const _ as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_IsolateFlags>())).unsafe_trust_strong_mode_types as *const _ as usize },
		17usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_IsolateFlags>())).copy_parent_code as *const _ as usize },
		18usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
...
fn bindgen_test_layout_Dart_QualifiedFunctionName() {
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_QualifiedFunctionName>())).library_uri as *const _ as usize },
		0usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_QualifiedFunctionName>())).class_name as *const _ as usize },
		8usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_QualifiedFunctionName),
	...
	assert_eq!(
		unsafe { &(*(::std::ptr::null::<Dart_QualifiedFunctionName>())).function_name as *const _ as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_QualifiedFunctionName),
