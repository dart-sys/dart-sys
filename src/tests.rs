...
fn bindgen_test_layout_Dart_CObjectValue() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_CObjectValue>())).as_send_port as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_CObjectValue>())).as_capability as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_CObjectValue>())).as_typed_data as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_CObjectValue>())).as_external_typed_data
                as *const _ as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_Dart_ExternalTypedData() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_ExternalTypedData>())).type_ as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_ExternalTypedData>())).length as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_ExternalTypedData>())).data as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_ExternalTypedData>())).peer as *const _
                as usize
        },
        24usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_ExternalTypedData>())).callback
                as *const _ as usize
        },
        32usize,
        concat!(
...
fn bindgen_test_layout_Dart_TypedData() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_TypedData>())).type_ as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_TypedData>())).length as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_TypedData>())).values as *const _
                as usize
        },
        16usize,
        concat!(
...
fn bindgen_test_layout_Dart_Array() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_Array>())).length as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_Array>())).values as *const _
                as usize
        },
        8usize,
        concat!(
...
fn bindgen_test_layout_Dart_Capability() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_Capability>())).id as *const _
                as usize
        },
        0usize,
        concat!(
...
fn bindgen_test_layout_Dart_SendPort() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_SendPort>())).id as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_SendPort>())).origin_id
                as *const _ as usize
        },
        8usize,
        concat!(
...
fn bindgen_test_layout_Dart_NativeFields() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_NativeFields>())).num_fields
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_NativeFields>())).values as *const _
                as usize
        },
        8usize,
        concat!(
...
fn bindgen_test_layout_Dart_NativeString() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_NativeString>())).dart_str
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Dart_NativeString>())).peer as *const _
                as usize
        },
        8usize,
        concat!(
