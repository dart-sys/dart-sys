...
#[no_mangle]
unsafe extern "C" fn dart_rust_async_ffi_Init(parent_library: ffi::Dart_Handle) -> ffi::Dart_Handle {
...
unsafe extern "C" fn ResloveName(
	name: ffi::Dart_Handle, _argc: std::os::raw::c_int, _auto_setup_scope: *mut bool,
...
unsafe extern "C" fn wrapped_random_array(_dest_port_id: ffi::Dart_Port, message: *mut ffi::Dart_CObject) {
	let reply_port_id;
