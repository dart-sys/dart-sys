...
//! [bindgen](https://crates.io/crates/bindgen) and the Dart SDK headers.
//!
...
fn bindgen_test_layout_Dart_IsolateFlags() {
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).snapshot_is_dontneed_safe) as usize - ptr as usize },
		12usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).branch_coverage) as usize - ptr as usize },
		13usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_IsolateFlags),
...
pub type Dart_RegisterKernelBlobCallback = ::std::option::Option<
	unsafe extern "C" fn(kernel_buffer: *const u8, kernel_buffer_size: isize) -> *const ::std::os::raw::c_char,
>;
/// Optional callback provided by the embedder that is used by the VM to
...
pub type Dart_UnregisterKernelBlobCallback =
	::std::option::Option<unsafe extern "C" fn(kernel_blob_uri: *const ::std::os::raw::c_char)>;
...
fn bindgen_test_layout_Dart_InitializeParams() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_InitializeParams> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).thread_start) as usize - ptr as usize },
		64usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).register_kernel_blob) as usize - ptr as usize },
		144usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).unregister_kernel_blob) as usize - ptr as usize },
		152usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_InitializeParams),
...
extern "C" {
	...
	pub fn Dart_CreateIsolateInGroup(
		group_member: Dart_Isolate, name: *const ::std::os::raw::c_char,
		shutdown_callback: Dart_IsolateShutdownCallback, cleanup_callback: Dart_IsolateCleanupCallback,
		child_isolate_data: *mut ::std::os::raw::c_void, error: *mut *mut ::std::os::raw::c_char,
	) -> Dart_Isolate;
}
extern "C" {
...
pub type Dart_HeapSamplingCallback = ::std::option::Option<
	unsafe extern "C" fn(
...
pub type Dart_PerformanceMode = ::std::os::raw::c_int;
extern "C" {
...
pub type Dart_MessageNotifyCallback = ::std::option::Option<unsafe extern "C" fn(destination_isolate: Dart_Isolate)>;
extern "C" {
...
extern "C" {
	...
	pub fn Dart_RunLoopAsync(
		errors_are_fatal: bool, on_error_port: Dart_Port, on_exit_port: Dart_Port,
		error: *mut *mut ::std::os::raw::c_char,
	) -> bool;
}
extern "C" {
...
extern "C" {
	...
	///
	/// \return A valid handle if no error occurs during the operation.
	pub fn Dart_StringToCString(str_: Dart_Handle, cstr: *mut *const ::std::os::raw::c_char) -> Dart_Handle;
}
extern "C" {
...
extern "C" {
	...
	pub fn Dart_StringGetProperties(
		str_: Dart_Handle, char_size: *mut isize, str_len: *mut isize, peer: *mut *mut ::std::os::raw::c_void,
	) -> Dart_Handle;
}
extern "C" {
...
pub type Dart_CoreType_Id = ::std::os::raw::c_int;
extern "C" {
...
pub type Dart_TypedData_Type = ::std::os::raw::c_int;
extern "C" {
...
extern "C" {
	...
	pub fn Dart_NewExternalTypedDataWithFinalizer(
		type_: Dart_TypedData_Type, data: *mut ::std::os::raw::c_void, length: isize,
		peer: *mut ::std::os::raw::c_void, external_allocation_size: isize, callback: Dart_HandleFinalizer,
	) -> Dart_Handle;
}
extern "C" {
	pub fn Dart_NewUnmodifiableExternalTypedDataWithFinalizer(
		type_: Dart_TypedData_Type, data: *const ::std::os::raw::c_void, length: isize,
		peer: *mut ::std::os::raw::c_void, external_allocation_size: isize, callback: Dart_HandleFinalizer,
	) -> Dart_Handle;
}
extern "C" {
...
pub type Dart_NativeArgument_Type = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout__Dart_NativeArgument_Descriptor() {
	const UNINIT: ::std::mem::MaybeUninit<_Dart_NativeArgument_Descriptor> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
fn bindgen_test_layout__Dart_NativeArgument_Value__bindgen_ty_1() {
	const UNINIT: ::std::mem::MaybeUninit<_Dart_NativeArgument_Value__bindgen_ty_1> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
fn bindgen_test_layout__Dart_NativeArgument_Value__bindgen_ty_2() {
	const UNINIT: ::std::mem::MaybeUninit<_Dart_NativeArgument_Value__bindgen_ty_2> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
fn bindgen_test_layout__Dart_NativeArgument_Value() {
	const UNINIT: ::std::mem::MaybeUninit<_Dart_NativeArgument_Value> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
pub type Dart_FfiNativeResolver = ::std::option::Option<
	unsafe extern "C" fn(name: *const ::std::os::raw::c_char, args_n: usize) -> *mut ::std::os::raw::c_void,
>;
...
pub type Dart_LibraryTag = ::std::os::raw::c_int;
...
pub type Dart_DeferredLoadHandler = ::std::option::Option<unsafe extern "C" fn(loading_unit_id: isize) -> Dart_Handle>;
extern "C" {
...
extern "C" {
	...
	pub fn Dart_DeferredLoadCompleteError(
		loading_unit_id: isize, error_message: *const ::std::os::raw::c_char, transient: bool,
	) -> Dart_Handle;
}
extern "C" {
...
pub const Dart_KernelCompilationStatus_Dart_KernelCompilationStatus_MsgFailed: Dart_KernelCompilationStatus = 3;
...
fn bindgen_test_layout_Dart_KernelCompilationResult() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_KernelCompilationResult> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
...
pub type Dart_KernelCompilationVerbosityLevel = ::std::os::raw::c_int;
extern "C" {
...
extern "C" {
	...
	pub fn Dart_CompileToKernel(
		...
		incremental_compile: bool, snapshot_compile: bool, package_config: *const ::std::os::raw::c_char,
...
extern "C" {
	...
	pub fn Dart_CompileToKernelWithGivenNullsafety(
		script_uri: *const ::std::os::raw::c_char, platform_kernel: *const u8, platform_kernel_size: isize,
		snapshot_compile: bool, package_config: *const ::std::os::raw::c_char, null_safety: bool,
		verbosity: Dart_KernelCompilationVerbosityLevel,
	) -> Dart_KernelCompilationResult;
}
#[repr(C)]
...
extern "C" {
	...
	pub fn Dart_DetectNullSafety(
		script_uri: *const ::std::os::raw::c_char, package_config: *const ::std::os::raw::c_char,
		original_working_directory: *const ::std::os::raw::c_char, snapshot_data: *const u8,
...
extern "C" {
	pub fn Dart_CreateAppAOTSnapshotAsAssemblies(
		next_callback: Dart_CreateLoadingUnitCallback, next_callback_data: *mut ::std::os::raw::c_void, stripped: bool,
...
pub type Dart_CObject_Type = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Copy, Clone)]
...
fn bindgen_test_layout_Dart_EmbedderInformation() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_EmbedderInformation> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).current_rss) as usize - ptr as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_EmbedderInformation),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).max_rss) as usize - ptr as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_EmbedderInformation),
...
fn bindgen_test_layout_Dart_GCStats() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_GCStats> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
		::std::mem::size_of::<Dart_GCStats>(),
		48usize,
		concat!("Size of: ", stringify!(Dart_GCStats))
	);
	assert_eq!(
		::std::mem::align_of::<Dart_GCStats>(),
		8usize,
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).avg_collection_period) as usize - ptr as usize },
		40usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_GCStats),
...
fn bindgen_test_layout_Dart_GCEvent() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_GCEvent> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
		::std::mem::size_of::<Dart_GCEvent>(),
		120usize,
		concat!("Size of: ", stringify!(Dart_GCEvent))
	);
	assert_eq!(
		::std::mem::align_of::<Dart_GCEvent>(),
		8usize,
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).isolate_group_id) as usize - ptr as usize },
		16usize,
		concat!(
			"Offset of field: ",
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).new_space) as usize - ptr as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_GCEvent),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).old_space) as usize - ptr as usize },
		72usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_GCEvent),
...
///   callback.
pub type Dart_GCEventCallback = ::std::option::Option<unsafe extern "C" fn(event: *mut Dart_GCEvent)>;
extern "C" {
...
extern "C" {
	...
	pub fn Dart_SetEnabledTimelineCategory(categories: *const ::std::os::raw::c_char) -> bool;
}
extern "C" {
...
pub type Dart_Timeline_Event_Type = ::std::os::raw::c_int;
extern "C" {
...
fn bindgen_test_layout_Dart_TimelineRecorderEvent_Argument() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_TimelineRecorderEvent_Argument> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
		::std::mem::size_of::<Dart_TimelineRecorderEvent_Argument>(),
		16usize,
		concat!("Size of: ", stringify!(Dart_TimelineRecorderEvent_Argument))
	);
	assert_eq!(
		::std::mem::align_of::<Dart_TimelineRecorderEvent_Argument>(),
		8usize,
...
pub struct Dart_TimelineRecorderEvent {
	...
	pub stream: *const ::std::os::raw::c_char,
...
fn bindgen_test_layout_Dart_TimelineRecorderEvent() {
	const UNINIT: ::std::mem::MaybeUninit<Dart_TimelineRecorderEvent> = ::std::mem::MaybeUninit::uninit();
	let ptr = UNINIT.as_ptr();
	assert_eq!(
		::std::mem::size_of::<Dart_TimelineRecorderEvent>(),
		72usize,
		concat!("Size of: ", stringify!(Dart_TimelineRecorderEvent))
	);
	assert_eq!(
		::std::mem::align_of::<Dart_TimelineRecorderEvent>(),
		8usize,
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).timestamp0) as usize - ptr as usize },
		8usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_TimelineRecorderEvent),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).timestamp1_or_async_id) as usize - ptr as usize },
		16usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_TimelineRecorderEvent),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).isolate) as usize - ptr as usize },
		24usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_TimelineRecorderEvent),
	...
	assert_eq!(
		unsafe { ::std::ptr::addr_of!((*ptr).isolate_group) as usize - ptr as usize },
		32usize,
		concat!(
			"Offset of field: ",
			stringify!(Dart_TimelineRecorderEvent),
...
pub type Dart_TimelineRecorderCallback =
	::std::option::Option<unsafe extern "C" fn(event: *mut Dart_TimelineRecorderEvent)>;
extern "C" {
...
extern "C" {
	pub fn Dart_NewUserTag(label: *const ::std::os::raw::c_char) -> Dart_Handle;
}
extern "C" {
	pub fn Dart_SetCurrentUserTag(user_tag: Dart_Handle) -> Dart_Handle;
}
extern "C" {
	pub fn Dart_GetUserTagLabel(user_tag: Dart_Handle) -> *mut ::std::os::raw::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
